        ...
        <div class="group">
            ...
            <div class="site-footer__col-two-three-group">
                <div class="site-footer__col-two">
                    ...
                    <nav class="nav-list">
                        <?php //wp_nav_menu(array('theme_location' => 'footerMenuLocationOne', 'container' => false)) ?>
                ...
                <div class="site-footer__col-three">
                    ...
                    <nav class="nav-list">
                        <?php //wp_nav_menu(array('theme_location' => 'footerMenuLocationTwo', 'container' => false)) ?>
                        <ul>
                            <li><a href="#">Legal</a></li>
                            <li><a href="
                        <?php echo site_url('/privacy-policy') ?>">Privacy</a></li>
